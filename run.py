...
<div class="auth-container" id="authPage">
  ...
  <div class="auth-card" id="loginCard">
    <div class="brand"><div class="logo-icon"><i class="fa-solid fa-code-merge"></i></div><div><b style="font-size:1.15rem">CodeSage <span style="color:var(--accent)">AI</span></b><br><small style="color:var(--muted);font-size:0.7rem"><i class="fa-solid fa-robot"></i> App Model Portal</small></div></div>
    <h2>Welcome Back</h2>
    ...
    <form id="login-form" class="auth-form">
      <div class="input-group"><label>Username</label><div class="input-field"><i class="fa-regular fa-user"></i><input type="text" id="login-email" placeholder="anisa" required></div></div>
      <div class="input-group"><label>Password</label><div class="input-field"><i class="fa-solid fa-lock"></i><input type="password" id="login-password" placeholder="••••••••" required></div></div>
  ...
  <div class="auth-card hidden" id="registerCard">
    <div class="brand"><div class="logo-icon"><i class="fa-solid fa-user-plus"></i></div><div><b style="font-size:1.15rem">Create <span style="color:var(--accent)">Account</span></b><br><small style="color:var(--muted);font-size:0.7rem">Join CodeSage AI</small></div></div>
    <h2>Register</h2>
    <p class="sub">Create account to access App Model</p>
    <form id="register-form" class="auth-form">
      <div class="input-group"><label>Username</label><div class="input-field"><i class="fa-regular fa-user"></i><input type="text" id="reg-username" placeholder="anisa" required></div></div>
      <div class="input-group"><label>Email (optional)</label><div class="input-field"><i class="fa-regular fa-envelope"></i><input type="email" id="reg-email" placeholder="you@email.com"></div></div>
      <div class="input-group"><label>Password</label><div class="input-field"><i class="fa-solid fa-lock"></i><input type="password" id="reg-password" placeholder="••••••••" required></div></div>
...
<!-- DASHBOARD - ONLY APP MODEL -->
<div class="app-dashboard" id="dashPage">
  <div class="app-header">
    <div class="header-left"><div class="logo-icon" style="width:32px;height:32px;font-size:0.9rem;border-radius:8px"><i class="fa-solid fa-code-merge"></i></div><b>CodeSage AI <span style="color:var(--accent)">Model</span></b><span style="font-size:0.6rem;background:#10b981;color:white;padding:3px 8px;border-radius:10px;margin-left:6px">● LIVE</span></div>
  ...
  <div class="model-wrap">
    <div class="loading" id="loadingOverlay"><div class="spinner"></div><div style="text-align:center"><p style="font-weight:600">Loading App Model...</p><p style="font-size:0.7rem;color:var(--muted);margin-top:4px">https://aashir-oss-codesage-ai-app-nerb3i.streamlit.app/</p></div></div>
...
function showDash(){
 ...
 frame.src=APP_URL;
 frame.onload=()=>{if(loading) loading.style.opacity='0'; setTimeout(()=>{if(loading) loading.style.display='none'},400); toast('App Model Loaded!')};
